...
const InsertEnterprise_selected = {
  Name: Joi.string().required(),
  Enterprise_Stored_ID: Joi.number()
    .integer()
    .required()
};
...
const InsertLink = {
  Enterprise_Evaluation_ID: Joi.number()
    .integer()
    .required(),
...
const InsertVariablesSelected = {
  Variable_1: Joi.number()
    .integer()
    .required(),
  Variable_2: Joi.number()
    .integer()
    .required(),
  Variable_3: Joi.number()
    .integer()
    .required(),
  Variable_4: Joi.number()
    .integer()
    .required(),
  Variable_5: Joi.number()
    .integer()
    .required(),
  Variable_6: Joi.number()
    .integer()
    .required(),
  Variable_7: Joi.number()
    .integer()
    .required(),
  Variable_8: Joi.number()
    .integer()
    .required(),
  Variable_9: Joi.number()
    .integer()
    .required(),
  Variable_10: Joi.number()
    .integer()
    .required(),
  Variable_11: Joi.number()
    .integer()
    .required(),
  Variable_12: Joi.number()
    .integer()
    .required(),
  Variable_13: Joi.number()
    .integer()
    .required(),
  Variable_14: Joi.number()
    .integer()
    .required(),
  Variable_15: Joi.number()
    .integer()
    .required(),
  Variable_16: Joi.number()
    .integer()
    .required(),
  Answer_1: Joi.number()
    .integer()
  ...
  Answer_9: Joi.number()
    .integer()
    .required(),
  Answer_10: Joi.number()
    .integer()
    .required(),
  Answer_11: Joi.number()
    .integer()
    .required(),
  Answer_12: Joi.number()
    .integer()
    .required(),
  Answer_13: Joi.number()
    .integer()
    .required(),
  Answer_14: Joi.number()
    .integer()
    .required(),
  Answer_15: Joi.number()
    .integer()
    .required(),
  Answer_16: Joi.number()
    .integer()
    .required()
};
